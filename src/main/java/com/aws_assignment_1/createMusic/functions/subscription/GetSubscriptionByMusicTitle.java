...
public class GetSubscriptionByMusicTitle implements RequestHandler<SubscriptionRequestByMusicTitle, SubscriptionResponse> {
    @Override
    public SubscriptionResponse handleRequest(SubscriptionRequestByMusicTitle input, Context context) {
        ...
        valueMap.put(":mc", input.getMusicTitle());

        QuerySpec spec = new QuerySpec()
                .withKeyConditionExpression("musicTitle = :mc")
