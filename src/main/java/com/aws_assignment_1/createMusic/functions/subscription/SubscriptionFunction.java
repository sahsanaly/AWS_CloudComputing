...
public class SubscriptionFunction implements RequestHandler<Subscription, Context> {
    @Override
    public Context handleRequest(Subscription input, Context context) {
        ...
        final Item item = new Item()
                ...
                .withString("musicTitle", input.getMusicTitle());
        table.putItem(item);
        return null;
    }
}
