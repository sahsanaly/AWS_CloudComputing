...
public class GetMusicByTitle implements RequestHandler<MusicRequestByTitle, MusicResponse> {
    @Override
    public MusicResponse handleRequest(MusicRequestByTitle input, Context context) {
        ...
        valueMap.put(":ttl", input.getTitle());

        QuerySpec spec = new QuerySpec()
                .withKeyConditionExpression("title = :ttl")
